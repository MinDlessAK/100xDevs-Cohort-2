...
what exactly going into ram or ssd ssd and ram is hardware at very lowest level our machine only understand 01 so inside our ram only 01 is understanding 
...
Note:- Variable types types can change in run time bcz its dynamic language So error change are most in these kind of language
       Also Js is Single threaded language that mean only one things can run at a time.
-======================================================================================================================================================================================
...
Static :- It mean you have to assign type to variables that cannot change further.
Dynamic :- It mean you Don't have to assign type to variables that can change further.
...
when ever we buy new machine we look at the specifications cores  what are these core  means 1 single core can run certain code at a single time which basically means 
...
this language javascript is always restricted to a single core if we have 10 lines of code they will always run one after the another you can never splits your programming of sort 
...
const means you cannot change value after assigned
we only use let or const var is not prefered 
const is introduce for safe value define

let in block level variable "{<block-level>}"

var in goloble level variable that why it change goloble variable value like keyword "name".
if we use name as variable with var it change goloble <name>

const is used to fixed the variable value and did'nt change further.

=================================================================================================================================================================================
datatypes ->data type is like which type of variable we are storing like int string boolean array object thats all 
=================================================================================================================================================================================
...
Objects are muteable: They are addressed by reference, not by value.                                  |
